...
class FileUploadService
{
    ...
    protected static function getDisk(string $disk = null): string
    {
        ...
        if (isset(FileUploadService::$studlyCache['disk_' . $key])) {
            return FileUploadService::$studlyCache['disk_' . $key];
        }

        $defaults = self::getConfig();

        return FileUploadService::$studlyCache['disk_' . $key] = $disk ?: $defaults['disk'];
    }
